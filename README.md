...
<!-- RESULTS:START -->
**Median ≈ 204k QALYs** (mean 224k; 90% interval 94k–424k), a blended **$149k/QALY**. Monetized at HHS's value per QALY that is **$150.3B** of health value — a **5.0× benefit/cost ratio**. The same $30.3B at the global-health frontier (~$197/QALY-equivalent), handicapped with the same realization and evidence discounts, would still buy ~105.58M QALYs — about **516× more health per dollar**, the price of funding a rich country's social fabric rather than the global frontier.
