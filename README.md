...
<!-- RESULTS:START -->
**Median ≈ 70k QALYs** (mean 76k; 90% interval 38k–136k), a blended **$435k/QALY**. Monetized at HHS's value per QALY that is **$51.6B** of health value — a **1.7× benefit/cost ratio**. The same $30.3B at the global-health frontier (~$197/QALY-equivalent), handicapped with the same realization and evidence discounts, would still buy ~105.43M QALYs — about **1510× more health per dollar**, the price of funding a rich country's social fabric rather than the global frontier.
