...
3. **Dollar allocation.** The split across 13 intervention archetypes is a
...
<!-- RESULTS:START -->
**Median ≈ 70k QALYs** (mean 77k; 90% interval 38k–138k), a blended **$432k/QALY**. Monetized at HHS's value per QALY that is **$52.1B** of health value — a **1.7× benefit/cost ratio**. The same $30.3B at the global-health frontier (~$197/QALY-equivalent), handicapped with the same realization and evidence discounts, would still buy ~105.52M QALYs — about **1499× more health per dollar**, the price of funding a rich country's social fabric rather than the global frontier.
