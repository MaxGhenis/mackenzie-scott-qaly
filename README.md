...
7. **Monetize & benchmark.** QALYs × VSLY (HHS 2026 central $611k) gives a
   ...
   (loguniform $50–150/QALY, central ~$87) — *handicapped with the same
   realization and credibility* so it is a like-for-like comparison, not a raw
   ceiling — give the counterfactual benchmark.
...
<!-- RESULTS:START -->
**Median ≈ 106k QALYs** (mean 114k; 90% interval 60k–191k), a blended **$248k/QALY**. Monetized at VSLY that is **$64.6B** of health value — a **2.5× benefit/cost ratio**. The same $26.3B at the global-health frontier (~$87/QALY), handicapped with the same realization and evidence discounts, would still buy ~207.91M QALYs — about **1955× more health per dollar**, the price of funding a rich country's social fabric rather than the global frontier.
